            ...
            <div className="space-y-8 flex flex-col justify-center">
              <div>
                ...
                <p className="text-muted-foreground mb-8">
                  Feel free to reach out through any of the methods below. I'm always open to discussing new projects, data challenges, or opportunities.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <span className="text-muted-foreground hover:text-primary cursor-pointer"
                        onClick={() => window.location.href = 'tel:+4915560011099'}>
                        +49 •••• ••11099
                      </span>
                    </div>
                  </div>
